...
<template>
    ...
    <div class="w-[300px] pr-4">
      ...
      <header>
          <nav class="flex justify-between w-full items-center ">
            ...
            <div class="w-[45px]">
                <img src="https://media.istockphoto.com/id/1180298940/photo/portrait-of-a-medical-director-at-the-hospital.jpg?s=1024x1024&w=is&k=20&c=Ky1PM2rCdHXMmzUyf2PenmyR4bXSepP6wCoyf_-7HDo=" alt="Ochilov. M" class="rounded-full">
  ...
  <section class="flex w-[1100px] ml-24 mt-10">
    ...
    <div class="flex flex-wrap gap-4 justify-beetwen items-center">
      ...
      <div class="flex justify-center items-center">
        <img class="w-[120px] h-[120px] object-cover justify-center items-center rounded-full" src="https://as1.ftcdn.net/v2/jpg/02/95/88/58/1000_F_295885809_ryl7NbEa2umWXpoTFWGFedc3xVIKlUBT.jpg" alt=""/>
      </div>
