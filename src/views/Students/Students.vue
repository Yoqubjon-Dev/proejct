    ...
    <div class="w-[300px] pr-4">
      <header>
          <nav class="flex justify-between w-full items-center ">
            ...
            <div>
              <h1 class="text-center font-bold">Shamsiyev. A</h1>
              <p class="text-center font-bold text-gray-500 text-[12px]">Admin</p>
            </div>
            <div class="w-[45px]">
                <img src="https://media.istockphoto.com/id/1180298940/photo/portrait-of-a-medical-director-at-the-hospital.jpg?s=1024x1024&w=is&k=20&c=Ky1PM2rCdHXMmzUyf2PenmyR4bXSepP6wCoyf_-7HDo=" alt="Ochilov. M" class="rounded-full object-cover">
            </div>
          </nav>
        </header>
      </div>
          ...
          <tbody class="bg-white justify-center items-center">
            <tr v-for="(el) in store.LIST" :key="el.id" class="border-b">
              ...
              <th scope="row" class="px-4 py-3 flex items-center gap-5">
                <img class="w-[45px] h-[45px] object-cover rounded-full mt-2" src="https://thumbs.dreamstime.com/z/young-man-programmer-working-computer-code-screen-student-programming-vector-concept-man-work-computer-programmer-102846347.jpg" alt="" />
